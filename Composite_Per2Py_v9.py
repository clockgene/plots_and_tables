...
v20240411 - Polar_scatterplot beta version. NO FILTERING or TraceHeatmaps or GIFS or TIFSEQUENCE for before_after_rhythm !!! Hope I solved bug with missing rows in Composite_parameters.csv
"""
# imports
import numpy  as np
import pandas as pd
...
# Choose to plot heatmap of K, Halflife, Trend, Phase, Amplitude or Period, or Phase_Histogram, Phase_ScatterPlot, Trace , Parameters, GIFS, TraceHeatmaps, TIFSEQUENCE
# Parameters do not need exp. specified and work on any n of folders, unless combineGroup = True. Copies animated gif files if graphtype is set to GIFS
...
name = -12               # -4 for nontreated CP, -5 for nontreated SCN, for treated CP -8, for treated SCN -12
