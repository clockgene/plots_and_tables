...
v20240104 - Polar_scatterplot beta version. NO FILTERING or TraceHeatmaps or GIFS or TIFSEQUENCE for before_after_rhythm !!! TIFSEQUENCE with customisable start.
"""
# imports
import numpy  as np
import pandas as pd
...
# FOR POLAR SCATTER PLOT, create r or y or amp, need testing and manual adjustment
def polarscatterplot(axh, title, pad=-12):
...
if experiment == 'rhythm':
    ...
    # Experimental plot, not tested yet
    if graphtype == 'Phase_ScatterPlot':
