...
# set number of rows, i.e. how many individual SCNs were analyzed. For Trend, HL and K, edit Nc and Nw variables.
Nr = 6
...
if graphtype == 'Phases_Histogram':
    ...
    fig, axh = plt.subplots(Nr, 2, subplot_kw={'projection': 'polar'})   
